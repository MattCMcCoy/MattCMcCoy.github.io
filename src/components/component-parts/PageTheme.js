...
export function ControlTheme() {
    ...
    const [theme, setTheme] = useState(storedTheme ?? "light"); //Default to light, may want to try and get the default browser mode here instead?
    const [checkedState, setState] = useState(theme === "dark");
